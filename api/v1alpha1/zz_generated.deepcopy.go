...
func (in *AccountSpec) DeepCopyInto(out *AccountSpec) {
	*out = *in
	...
	if in.GlobalServiceQuotas != nil {
		in, out := &in.GlobalServiceQuotas, &out.GlobalServiceQuotas
		*out = make(AccountServiceQuota, len(*in))
		for key, val := range *in {
			var outVal *ServiceQuotaStatus
			if val == nil {
...
func (in *AccountStatus) DeepCopyInto(out *AccountStatus) {
	*out = *in
	...
	if in.OptInRegions != nil {
		in, out := &in.OptInRegions, &out.OptInRegions
		*out = make(OptInRegions, len(*in))
		for key, val := range *in {
			var outVal *OptInRegionStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
				in, out := &inVal, &outVal
				*out = new(OptInRegionStatus)
				**out = **in
			}
			(*out)[key] = outVal
		}
