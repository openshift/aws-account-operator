...
export RESOURCE_DELETE_TIMEOUT="${RESOURCE_DELETE_TIMEOUT:-3m}"  # Reduced from 6m - finalizers removed immediately now
...
function deleteNamespace {
    ...
    # This avoids waiting for finalizer timeout on the first attempt
