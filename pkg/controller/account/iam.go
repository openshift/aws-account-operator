...
func (r *ReconcileAccount) ProbeSecret(reqLogger logr.Logger, currentAcctInstance *awsv1alpha1.Account,
...
func (r *ReconcileAccount) IsKubeSecretValid(reqLogger logr.Logger, currentAcctInstance *awsv1alpha1.Account) (bool, error) {
...
func (r *ReconcileAccount) ValidateIAMSecret(reqLogger logr.Logger, awsClient awsclient.Client, account *awsv1alpha1.Account,
...
func (r *ReconcileAccount) updateIAMUserSecret(reqLogger logr.Logger, account *awsv1alpha1.Account, secretName types.NamespacedName, createAccessKeyOutput *iam.CreateAccessKeyOutput) error {
