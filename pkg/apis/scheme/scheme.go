// Copied from https://github.com/kubernetes-sigs/controller-runtime/blob/master/pkg/scheme/scheme.go
// in order to remove the "sigs.k8s.io/controller-runtime/pkg/scheme" dependency
/*
