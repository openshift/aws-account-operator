...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSFederatedStateCondition) DeepCopyInto(out *AWSFederatedStateCondition) {
	*out = *in
	in.LastProbeTime.DeepCopyInto(&out.LastProbeTime)
	in.LastTransitionTime.DeepCopyInto(&out.LastTransitionTime)
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSFederatedStateCondition.
func (in *AWSFederatedStateCondition) DeepCopy() *AWSFederatedStateCondition {
	if in == nil {
		return nil
	}
	out := new(AWSFederatedStateCondition)
	in.DeepCopyInto(out)
	return out
}
