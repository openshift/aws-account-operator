...
- `aws-account-operator-pull-request.yaml`: PR validation
- `aws-account-operator-push.yaml`: Main branch builds
- `aws-account-operator-pko-pull-request.yaml`: PKO validation
- `aws-account-operator-pko-push.yaml`: PKO deployment
...
# tkn pipeline validate -f .tekton/aws-account-operator-pull-request.yaml
...
```text
CI Status: FAILING
Pipeline: aws-account-operator-pull-request
Stage: golangci-lint
Error: Exit code 1
