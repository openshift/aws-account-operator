...
`make test-all` combines a number of test suites together to make things easier to validate the state of the cluster. If prefered, indivual test suites can be run, such as:
```
