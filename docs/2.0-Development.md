...
- Environment Variables:
    Setup `.envrc` file in root folder as per [documentation](https://github.com/openshift/aws-account-operator/blob/master/docs/1.1-InstallationPrerequisites.md#115-environment-variables).
    Required variables:
    ```bash
    export AWS_PAGER=
